...
- [x] 窗口点验：福州通用九卡 + 兴化回访行会（不是应对烂账）
- [x] 窗口点验：F11 福州九卡 → 寺观细看废烽堠（耗日、名声仍 0）→ 市舶司呈报（+70 钱 / +7 声）
- [x] 寺观拓碑：已勘见的近侧旧迹耗日写入边记，不给名声
- [x] 窗口点验：福州寺观拓碑废烽堠 → 住处边记能看见，名声仍 0
- [x] 港口界面修剪：九卡收进 720、调查页按文收高、选项统一挑签、开场白改短句
- [x] 绢本做实：熟漆不透底、暖色压暗、港名匾、图标金框、卷首册页、海图与海战 HUD 同一套宋体
