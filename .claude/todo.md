...
- [ ] 底图伪 UI：`assets/bg_fuzhou_yamen.jpg` 左上角画着一块「进士题名 历年名录」的伪界面牌（AI 出图带的，PIL 裁图实证），福州港页上像一块漏掉的控件——归视觉线，需抹掉重出
- [ ] 船况面板末行「针路 静风 7 日 遇事约 7 日 八成 8 日 水粮足 20 日」在 1280 宽下折行，「日」字孤悬——归海图线，小
