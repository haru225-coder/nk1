...
debug 构建下：**F11** 跳泉州港，再按跳福州（通用八卡），再按跳兴化回访；**F10** 海图强刷海盗遭遇；**F12** 预览第四章了结弹窗——云电脑/无头环境点验用，正式构建不响应。
...
- ✅ 港卡三页接线：行会出港行情（信用加条数）、贡院誊录（工钱+学者倾向、不给名声）、住宅边记与便宜歇息（候风仍去旅店）；通用港同样八卡；兴化回访不再进序章调查页
